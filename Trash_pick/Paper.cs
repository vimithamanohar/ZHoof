...
namespace Trash_pick
{
    class Paper
    {
        ...
        public Paper(Vector2 position, Texture2D tex) //Our constructor
        {
        ...
        public void Draw(SpriteBatch batch, Vector2 position, Texture2D tex) //Draw function, same as mousehandler one.
        {
            ...
            paper_rect=new Rectangle(tempx, tempy, 40, 35);
              batch.Draw(tex,paper_rect, Color.White);
        }
    }
}
